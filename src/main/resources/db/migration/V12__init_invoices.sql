...
CREATE TABLE invoices (
    ...
    INDEX idx_invoices_linked_invoice_id (linked_invoice_id),
...
INSERT INTO invoices_history (
    id, manager_id, order_id, customer_id, total_amount, invoice_type, linked_invoice_id, invoice_sequence_number,
    payment_method, payment_proof, allocation_number,
    s3_key, file_name, file_size_bytes, mime_type,
    created_at, updated_at
)
VALUES (
    NEW.id, NEW.manager_id, NEW.order_id, NEW.customer_id, NEW.total_amount, NEW.invoice_type, NEW.linked_invoice_id, NEW.invoice_sequence_number,
