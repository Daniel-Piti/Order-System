...
INSERT INTO customers_history (id, user_id, name, phone_number, created_at, updated_at)
VALUES (NEW.id, NEW.user_id, NEW.name, NEW.phone_number, NEW.created_at, NEW.updated_at);
